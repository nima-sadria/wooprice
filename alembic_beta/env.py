"""WooPrice Beta — Alembic environment configuration for Beta migrations.

Beta-specific migrations (beta_001, beta_002, ...) use this env.py.
A2 migrations (a2_000 through a2_008) use alembic_a2/env.py — do not modify.
