...
| I — Beta Architecture Blueprint | `docs/beta/` + `docs/control-plane/`; B1 CLOSED · B2 CLOSED · B3 CLOSED · B4 CLOSED · B5 CLOSED · CP1.1 CLOSED · **CP1.2 CLOSED · CP1.3 NOT STARTED** |
